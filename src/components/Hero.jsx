...
function NodeIcon({ colored }) {
  return (
    <svg viewBox="0 0 256 289" width="13" height="14">
      <path fill={colored ? "#539E43" : "currentColor"} d="M128 288.464c-3.975 0-7.685-1.06-11.13-2.915l-35.247-20.936c-5.3-2.915-2.65-3.975-1.06-4.505 7.155-2.385 8.48-2.915 15.9-7.156.796-.53 1.856-.265 2.65.265l27.032 16.166c1.06.53 2.385.53 3.18 0l105.74-61.217c1.06-.53 1.59-1.59 1.59-2.915V83.086c0-1.325-.53-2.385-1.59-2.915L129.06 19.172c-1.06-.53-2.385-.53-3.18 0L20.14 80.17c-1.06.53-1.59 1.855-1.59 2.915v122.17c0 1.06.53 2.385 1.59 2.915l28.887 16.695c15.636 7.95 25.44-1.325 25.44-10.6V93.685c0-1.59 1.325-3.18 3.18-3.18h13.516c1.59 0 3.18 1.325 3.18 3.18v120.58c0 20.936-11.396 33.127-31.272 33.127-6.095 0-10.865 0-24.38-6.625l-27.827-15.9C4.24 221.42 0 214.265 0 206.58V84.41c0-7.686 4.24-14.84 11.13-18.55L116.87 4.376c6.625-3.71 15.37-3.71 21.996 0l105.74 61.482c6.89 3.71 11.13 10.865 11.13 18.55v122.17c0 7.686-4.24 14.84-11.13 18.816l-105.74 61.216c-3.18 1.59-6.89 2.385-10.865 2.385"/>
    </svg>
  )
}
