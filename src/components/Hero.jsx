...
function NodeIcon({ colored }) {
  return (
    <svg viewBox="0 0 24 24" width="13" height="13" fill={colored ? "#539E43" : "currentColor"}>
      <path d="M11.998 24c-.321 0-.641-.084-.922-.247L8.14 22.017c-.438-.245-.224-.332-.08-.383.656-.228.789-.28 1.49-.678.073-.04.17-.025.245.015l2.244 1.332c.082.046.198.046.275 0l8.748-5.05c.083-.047.136-.14.136-.238V6.965c0-.1-.053-.19-.139-.24l-8.744-5.047c-.083-.046-.192-.046-.274 0L3.297 6.726c-.087.05-.14.143-.14.241v10.048c0 .097.053.19.137.236l2.396 1.384c1.3.65 2.096-.116 2.096-.888V7.787c0-.142.114-.253.256-.253h1.115c.139 0 .255.11.255.253v9.96c0 1.737-.946 2.733-2.593 2.733-.506 0-.906 0-2.02-.548l-2.293-1.32A1.854 1.854 0 0 1 1.6 17.013V6.965c0-.655.348-1.267.922-1.593L11.268.32a1.918 1.918 0 0 1 1.846 0l8.745 5.052c.574.326.922.938.922 1.593v10.048c0 .655-.348 1.267-.922 1.594l-8.745 5.05c-.28.163-.6.247-.922.247z"/>
    </svg>
  )
}
...
function OutSystemsIcon({ colored }) {
  return (
    <svg viewBox="0 0 25 26" width="13" height="14" fill={colored ? "#E8372C" : "currentColor"}>
      <path fillRule="evenodd" clipRule="evenodd" d="M9.46749 13.6799C9.56417 14.6137 10.0043 15.4787 10.7028 16.1075C11.4013 16.7364 12.3086 17.0845 13.2492 17.0845C14.1899 17.0845 15.0972 16.7364 15.7957 16.1075C16.4942 15.4787 16.9344 14.6137 17.031 13.6799C17.0438 13.5522 17.0502 13.4228 17.0502 13.2918C17.0545 12.7909 16.9593 12.2941 16.7703 11.8301C16.5812 11.366 16.3019 10.944 15.9485 10.5883C15.5951 10.2325 15.1746 9.95019 14.7114 9.7575C14.2481 9.56482 13.7512 9.4656 13.2492 9.4656C12.7474 9.4656 12.2504 9.56482 11.7871 9.7575C11.3239 9.95019 10.9034 10.2325 10.55 10.5883C10.1967 10.944 9.91737 11.366 9.72828 11.8301C9.53919 12.2941 9.44404 12.7909 9.44833 13.2918C9.44833 13.4224 9.45472 13.5521 9.46749 13.6799ZM3 13.2302C2.99994 11.207 3.60105 9.22902 4.72729 7.54667C5.85353 5.8643 7.45432 4.55305 9.32723 3.77874C11.2001 3.00443 13.261 2.80184 15.2494 3.19658C17.2376 3.59132 19.0639 4.56567 20.4974 5.9964C21.9308 7.42713 22.907 9.25 23.3025 11.2344C23.6979 13.2189 23.4949 15.2759 22.719 17.1452C21.9431 19.0145 20.6293 20.6121 18.9437 21.7362C17.2581 22.8602 15.2763 23.4601 13.2491 23.46C11.9032 23.46 10.5704 23.1954 9.32689 22.6813C8.08339 22.1672 6.95352 21.4137 6.0018 20.4638C5.05008 19.5139 4.29514 18.3861 3.78009 17.145C3.26504 15.9039 2.99996 14.5736 3 13.2302Z"/>
    </svg>
  )
}
function MapPinIcon() {
